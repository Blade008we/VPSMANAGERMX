...
wget https://raw.githubusercontent.com/Blade008we/VPSMANAGERMX/VPS-MX_Oficial/ArchivosUtilitarios/common-password -O /etc/pam.d/common-password > /dev/null 2>&1
