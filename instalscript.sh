...
if [ ! -d "$INSTALL_DIR" ]; then
    ...
    wget https://raw.githubusercontent.com/Blade008we/VPSMANAGERMX/main/VPS-MX_Oficial/zzupdate-master/zzupdate.default-si.conf -O /usr/local/vpsmxup/vpsmxup.default.conf  &> /dev/null
	chmod +x /usr/local/vpsmxup/vpsmxup.default.conf 
	rm -rf /usr/local/vpsmxup/vpsmxup.sh
    wget https://raw.githubusercontent.com/Blade008we/VPSMANAGERMX/main/VPS-MX_Oficial/zzupdate-master/zzupdate.default.conf -O /usr/local/vpsmxup/vpsmxup.default.conf &> /dev/null
	chmod +x /usr/local/vpsmxup/vpsmxup.default.conf
	rm -rf /root/VPS-MX
    wget https://raw.githubusercontent.com/Blade008we/VPSMANAGERMX/main/VPS-MX -O /root/VPS-MX &> /dev/null
	chmod +x /root/VPS-MX
...
ubu16_fun () {
    wget -O /etc/apt/sources.list https://raw.githubusercontent.com/Blade008we/VPSMANAGERMX/main/VPS-MX_Oficial/Repositorios/16.04/sources.list &> /dev/null
	echo -e "\033[1;97m SELECCIONO UBU 16"
}

ubu18_fun () {
    wget -O /etc/apt/sources.list https://raw.githubusercontent.com/Blade008we/VPSMANAGERMX/main/VPS-MX_Oficial/Repositorios/18.04/sources.list &> /dev/null
